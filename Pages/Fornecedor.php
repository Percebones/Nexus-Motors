 ...
 ORDER BY pecas.id DESC";
  ...
  <main>
    <div class="main-content">
          ...
          <tr>
            <td>
                ...
                <div class="conteudo-card" id="conteudo2">
                  ...
                  <div class="cadastro-container">
                    <form action="conexao.php" method="post">
                      <fieldset>
                        <legend style="text-align:center;">Informações do Fornecedor</legend>
                        <br>
              ...
              <div class="card" id="meuCard3">
                <!--  -->
                <h3>Exclusao de Fornecedor<button class="botao-card" onclick="abrefecha('conteudo3', 'meuCard3')">↓</button>
                </h3>
      ...
      <!--  -->
      <div class="card" id="meuCard3">
        <h3>Atualizacao de Fornecedor<button class="botao-card" onclick="abrefecha('conteudo3', 'meuCard3')">↓</button>
        </h3>
        <div class="conteudo-card" id="conteudo3">
